! function(global) {
    if (!global.WeixinJSBridge) {
        ...
        var invokeHandler = function(event, paramString, callbackId) {
                if (isIOS) global.webkit.messageHandlers.invokeHandler.postMessage({
                    ...
                    var callRes = WeixinJSCore.invokeHandler(event, paramString, callbackId);
                    if ("undefined" != typeof callRes && "function" == typeof callbacks[callbackId]) {
                        try {
                            callRes = JSON.parse(callRes)
                        } catch (e) {
                            callRes = {}
                        }
                        callbacks[callbackId](callRes), delete callbacks[callbackId]
                    }
                }
            },
            postMessage__ = function(event, paramString, webViewId) {
                isIOS ? global.webkit.messageHandlers.publishHandler.postMessage({
                    event: event,
                    paramsString: paramString,
                    webviewIds: webViewId
                }) : WeixinJSCore.publishHandler(event, paramString, webViewId)
            },
            invoke = function(event, param, callback) {
                var paramString = JSON.stringify(param || {}),
                    callbackId = ++i;
                callbacks[callbackId] = callback, invokeHandler(event, paramString, callbackId)
            },
            ...
            publish = function(eventname, t, n) {
                n = n || [], n = JSON.stringify(n);
                var o = customPrefix + eventname,
                    r = JSON.stringify(t);
                postMessage__(o, r, n)
            },
            subscribe = function(eventname, handler) {
                handlers[customPrefix + eventname] = handler
            },
            subscribeHandler = function(eventName, t, n, o) {
                var handler;
                handler = eventName.indexOf(customPrefix) != -1 ? handlers[eventName] : a[eventName], "function" == typeof handler && handler(t, n, o)
            };
