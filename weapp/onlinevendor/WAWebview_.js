...
function _toArray(e) {
    ...
    if (!global.WeixinJSBridge) {
        if (global.navigator && global.navigator.userAgent) {
            var t = global.navigator.userAgent;
            if (t.indexOf("appservice") > -1 || t.indexOf("wechatdevtools") > -1) return
        }
        var n = global.hasOwnProperty("document"),
            i = !1,
            r = {},
            o = 0,
            a = {},
        ...
        var d = function(t, n, o) {
                if (i) global.webkit.messageHandlers.invokeHandler.postMessage({
                    event: t,
                    paramsString: n,
                    callbackId: o
                });
            ...
            u = function(t, n, r) {
                i ? global.webkit.messageHandlers.publishHandler.postMessage({
                    event: t,
                    paramsString: n,
                    webviewIds: r
...
var Reporter = function(e) {
    ...
    exparser = function(defines) {
        function t(moduleIndex) {
            if (modules[moduleIndex]) return modules[moduleIndex].exports;
            var r = modules[moduleIndex] = {
                exports: {},
                id: moduleIndex,
                loaded: !1
            };
            return defines[moduleIndex].call(r.exports, r, r.exports, t), r.loaded = !0, r.exports
        }
        var modules = {};
        return t.m = defines, t.c = modules, t.p = "", t(0)
    }([function _0(e, module, require) {
        var Event = require(1),
            Behavior = require(3),
            Element = require(4),
            Component = require(5),
            Text = require(9),
            Observer = require(10);
        module.Behavior = Behavior, module.Element = Element, module.Component = Component, module.Observer = Observer, module.registerBehavior = Behavior.create, module.registerElement = Component.register, module.createElement = Component.create, module.createTextNode = Text.create, module.addListenerToElement = Event.addListenerToElement, module.addListenerToShadowRoot = Event.addListenerToShadowRoot, module.removeListenerFromElement = Event.removeListenerFromElement, module.removeListenerFromShadowRoot = Event.removeListenerFromShadowRoot, module.triggerEvent = Event.triggerEvent, module.triggerDocumentEvent = Event.triggerDocumentEvent
    }, function Event(e, t, n) {
        var i = n(2),
            r = function(e) {
                if (e) {
        ...
        u.register = function(e) {
            ...
            !n.template && p && "TEMPLATE" === p.tagName || (p = document.createElement("template"), p.innerHTML = n.template || ""), r.__defaultValues = JSON.stringify(c), r.__template = ParseTmp(p, c, n.methods);
                                ...
                                if ("WX-CONTENT" !== h.tagName)
                                    if ("WX-REPEAT" !== h.tagName) {
                                        ...
                                        var D = a(h.attributes),
                                            ...
                                            F = Repeat.parseWxRepeat(h, t[P], n, {
                                                index: D.index || "index",
                                                item: D.item || "item"
                                            });
                                        g.push({
...
function(window) {
    ...
    }, !0), window.addEventListener("error", function(e) {
...
function(window) {
    ...
    }, !0), window.addEventListener("reset", function(e) {
...
function(window) {
    ...
    }, !0), window.addEventListener("keypress", function(e) {
        exparser.triggerDocumentEvent(e, "keypress")
    }, !0), window.addEventListener("input", function(e) {
...
function(window) {
    ...
    }, !0), window.addEventListener("touchstart", function(e) {
    ...
    }, !0), window.addEventListener("mousemove", function(e) {
        !a && s && (r(e), exparser.triggerDocumentEvent(e, "touchmove"), v(e, e.pageX, e.pageY))
    }, !0), window.addEventListener("mouseup", function(e) {
    ...
    function() {
        ...
        var _ = {
            ...
            C = function(e) {
                e.ext && ("undefined" != typeof e.ext.webviewId && (window.__webviewId__ = e.ext.webviewId), "undefined" != typeof e.ext.downloadDomain && (window.__downloadDomain__ = e.ext.downloadDomain)), p.default.setData(e.data), b = m(p.default.getData(), !0), x = b.render(), x.replaceDocumentElement(document.body), setTimeout(function() {
        ...
        document.addEventListener("generateFuncReady", function(e) {
            k.funcReady = Date.now(), r("funcReady", k.webviewStartTime, k.funcReady), window.__generateFunc__ = e.detail.generateFunc, wx.onAppDataChange && window.__generateFunc__ && wx.onAppDataChange((0, d.catchError)(function(e) {
                k.renderStart = Date.now(), e.options && e.options.firstRender ? (r("firstGetData", k.funcReady, k.renderStart), C(e), r("firstRenderTime", k.renderStart, Date.now())) : (e.options && "action" === e.options.type ? I(e) : E(e), document.dispatchEvent(new CustomEvent("pageReRender", {})), r("reRenderTime", k.renderStart, Date.now()))
